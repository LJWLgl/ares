...
@Repository
public class PeopleFavoriteCounter extends AbstractCounter{

  private static final String PEOPLE_FAVORITE_FIELD = "people_favorite";
  ...
  public void incrCount(Integer resourceId, CounterDomain domain) {
    incrCount(String.valueOf(resourceId), String.valueOf(domain.getValue()), PEOPLE_FAVORITE_FIELD, 1);
  }

  public void decrCount(Integer resourceId, CounterDomain domain) {
    decrCount(String.valueOf(resourceId), String.valueOf(domain.getValue()), PEOPLE_FAVORITE_FIELD, 1);
  }

  public long findCount(Integer resourceId, CounterDomain domain) {
    return findCount(resourceId, String.valueOf(domain.getValue()), PEOPLE_FAVORITE_FIELD);
  }

  public Map<Integer, Long> queryCount(List<Integer> resourceIds, CounterDomain domain) {
    return queryCount(resourceIds, String.valueOf(domain.getValue()), PEOPLE_FAVORITE_FIELD);
  }
